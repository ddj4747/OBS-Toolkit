...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/plugin/src/plugin-support.c.in")
  configure_file(plugin/src/plugin-support.c.in plugin-support.c @ONLY)
  add_library(plugin-support STATIC)
  target_sources(plugin-support PRIVATE plugin-support.c PUBLIC plugin/inc/plugin-support.h)
  target_include_directories(plugin-support PUBLIC "${CMAKE_CURRENT_SOURCE_DIR}/plugin/inc")
  if(OS_LINUX OR OS_FREEBSD OR OS_OPENBSD)
    set_property(TARGET plugin-support PROPERTY POSITION_INDEPENDENT_CODE ON)
  endif()
elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/plugin-support.c.in")
