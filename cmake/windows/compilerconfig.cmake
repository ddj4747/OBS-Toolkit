...
if(CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION)
  set(OBS_WINDOWS_SDK_VERSION ${CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION})
elseif(DEFINED ENV{WindowsSDKVersion})
  string(STRIP "$ENV{WindowsSDKVersion}" OBS_WINDOWS_SDK_VERSION)
  string(REGEX REPLACE "\\\\$" "" OBS_WINDOWS_SDK_VERSION "${OBS_WINDOWS_SDK_VERSION}")
else()
  set(OBS_WINDOWS_SDK_VERSION ${CMAKE_SYSTEM_VERSION})
endif()

message(DEBUG "Resolved Windows SDK version: ${OBS_WINDOWS_SDK_VERSION}")

if(OBS_WINDOWS_SDK_VERSION VERSION_LESS 10.0.20348)
  message(
    FATAL_ERROR
